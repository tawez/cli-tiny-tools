...
{
  std::cout << "List available serial ports or find serial ports of which ID contains given pattern" << std::endl;
  std::cout << "Usage: " << prog.filename().string() << " [options] [pattern]" << std::endl;
